...
public class PdfGeneratorService {
    public ByteArrayInputStream generateMedicalFilePdf(DossierMedicalDTO medicalFile) {
        ...
        try {
            ...
            document.add(new Paragraph("ID Patient : " + medicalFile., textFont));
            document.add(new Paragraph("Dossier créé le : " + medicalFile.getDateCreation(), textFont));
